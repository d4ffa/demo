...
<head>
    ...
    <title>SIPOIN (Sistem Informasi Poin Pelanggaran) - SMAN 1 BANDUNG</title>
        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div style="margin:auto;display:block;padding-right: 6px;">
                  <img style="width: 150px;display:block;text-align:center;margin:auto;/* margin: 0 0 0 0; */" src=https://lib.sman1bdg.sch.id/wp-content/uploads/2019/07/SMANSA-LOGO_BAWAH_WHITE_NEW-copy-300x127.png>
                </div>
              </div>
        </div>
    </div>
